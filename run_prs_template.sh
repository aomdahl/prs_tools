...
python $SC/prs_tools/calc_prs.py -snps new_plink -ss filtered_NEAL.ss --pvals 1,0.5,0.1,0.01,0.001,1e-4,1e-6,5e-8  -o results_jan9 -pv 2 --reset_ids --ss_format DEFAULT --prefiltered_ss --preprocessing_done
