...
#these will be kept in a separate var file
#TARGET="/work-zfs/abattle4/marios/HF_GWAS/cohorts/CHS/merged_genotypes/CNV370v1/preimpute/race1/unrelated/unrelated_pfile"
#SS="/work-zfs/abattle4/ashton/prs_dev/neal_ukbb_sumstats/bmi/21001_irnt.gwas.imputed_v3.both_sexes.tsv"
...
#enriched_dir="SET BY USER"
#enriched="Enriched_variants by user"
#background="Background variants by user"
#background_dir="Directory to run background PRS, where it has been done so far."
...
#Run through clumping, use that list
